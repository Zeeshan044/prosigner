...
<section class="py-8 container mx-auto font-mulish text-primary">
  <div class="w-full">
    <div class="px-16">
      <div class="">
      ...
      <div class="overflow-hidden max-h-[10000px] mt-8">
        <table id="features-table" class="w-full mx-auto hidden">
          <thead>
            <tr>
              <th
