...
<div class="alert alert-error max-w-lg mt-2">
  ...
  >
  <div>
    <div class="font-bold">Integration Problems</div>
    <div class="my-2">
      Currently the system have a server issue, we are working hard on getting
    ...
    <div class="my-2">
      ...
      but the templates section is broken. demos.
    </div>
  </div>
</div>
